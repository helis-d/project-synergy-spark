...
export function Toolbar({
  ...
  return (
    <header className="north-no-print col-span-full flex flex-col border-b border-line bg-panel/95 backdrop-blur-sm">
      {/* Row 1 — application menu bar (desktop only; mobile uses the palette) */}
      <div className="hidden h-9 shrink-0 items-center gap-1 border-b border-line/60 px-2 sm:px-3 lg:flex">
        <MenuBar
          actions={actions}
        ...
        <button
          ...
          className="ml-auto inline-flex h-6 items-center gap-1.5 rounded-md border border-line bg-background/60 px-2 text-[11.5px] text-ink-dim transition-colors hover:bg-background"
          title="Komut paleti"
        >
      ...
      {/* Row 2 — contextual formatting toolbar */}
      <div className="grid min-h-14 grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 px-2 sm:px-4">
